            ...
            switch (_a.label) {
                case 0:
                    if (records.dashUniqueIdentityId) {
                        records.dashUniqueIdentityId = Identifier_1.default.from(records.dashUniqueIdentityId);
                    }
                    if (records.dashAliasIdentityId) {
                        records.dashAliasIdentityId = Identifier_1.default.from(records.dashAliasIdentityId);
                    }
