...
proto.org.dash.platform.dapi.v0.Proof.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    storeTreeProof: msg.getStoreTreeProof_asB64()
  };
...
proto.org.dash.platform.dapi.v0.Proof.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getStoreTreeProof_asU8();
  if (f.length > 0) {
    writer.writeBytes(
      2,
      f
...
/**
 * optional bytes store_tree_proof = 2;
 * @return {string}
 */
proto.org.dash.platform.dapi.v0.Proof.prototype.getStoreTreeProof = function() {
...
/**
 * optional bytes store_tree_proof = 2;
 * This is a type-conversion wrapper around `getStoreTreeProof()`
 * @return {string}
 */
proto.org.dash.platform.dapi.v0.Proof.prototype.getStoreTreeProof_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getStoreTreeProof()));
};
 ...
 * @return {!Uint8Array}
 */
proto.org.dash.platform.dapi.v0.Proof.prototype.getStoreTreeProof_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getStoreTreeProof()));
};
 ...
 * @return {!proto.org.dash.platform.dapi.v0.Proof} returns this
 */
proto.org.dash.platform.dapi.v0.Proof.prototype.setStoreTreeProof = function(value) {
