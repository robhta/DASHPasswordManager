...
var Client = /** @class */ (function () {
    ...
    function Client(options) {
        ...
        this.walletAccountIndex = 0;
        this.options = __assign({ walletAccountIndex: 0 }, options);
        ...
        if (this.options.wallet !== undefined) {
            ...
            var transport = new DAPIClientTransport_1.default(this.dapiClient);
            this.wallet = new wallet_lib_1.Wallet(__assign({ transport: transport, network: this.network }, this.options.wallet));
            // @ts-ignore
            this.walletAccountIndex = this.options.walletAccountIndex;
        }
        this.apps = new ClientApps_1.ClientApps(Object.assign({
            dpns: {
    ...
    Client.prototype.getWalletAccount = function (options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                options = __assign({ index: this.walletAccountIndex }, options);
