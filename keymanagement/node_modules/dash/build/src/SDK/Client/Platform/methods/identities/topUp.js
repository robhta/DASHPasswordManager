    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    account = _b.sent();
                    return [4 /*yield*/, createAssetLockTransaction_1.default(this, amount)];
                case 2:
                ...
                case 4:
                    ...
                    return [4 /*yield*/, createIdnetityTopUpTransition_1.default(this, assetLockTransaction, assetLockOutputIndex, assetLockProof, assetLockPrivateKey, identityId)];
                case 5:
                    identityTopUpTransition = _b.sent();
                    // Broadcast ST
                    return [4 /*yield*/, client.getDAPIClient().platform.broadcastStateTransition(identityTopUpTransition.toBuffer())];
                case 6:
                    // Broadcast ST
                    _b.sent();
