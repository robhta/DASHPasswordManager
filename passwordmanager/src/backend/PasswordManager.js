...
var dapi = require("./drive-persistence/dapi");
var pwdManager = require("./cryptography/pwdManager");
var keyManager = require("./keymanagement/keyderivation");
                    ...
                    case 0:
                        ...
                        clientOpts = {
                            ...
                            wallet: {
                                mnemonic: mnemonic,
                                unsafeOptions: {
                                    skipSynchronizationBeforeHeight: 500000
                                }
                            },
                            apps: {
                                passwordManager: {
