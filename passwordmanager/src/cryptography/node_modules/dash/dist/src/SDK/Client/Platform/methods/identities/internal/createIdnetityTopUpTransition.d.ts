 ...
 */
export default function createIdentityTopUpTransition(platform: Platform, assetLockTransaction: Transaction, assetLockOutputIndex: number, assetLockProof: any, assetLockPrivateKey: PrivateKey, identityId: any): Promise<any>;
