 ...
 */
function createIdentityTopUpTransition(platform, assetLockTransaction, assetLockOutputIndex, assetLockProof, assetLockPrivateKey, identityId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    dpp = platform.dpp;
                    identityTopUpTransition = dpp.identity.createIdentityTopUpTransition(identityId, assetLockTransaction, assetLockOutputIndex, assetLockProof);
                    identityTopUpTransition.signByPrivateKey(assetLockPrivateKey);
                    return [4 /*yield*/, dpp.stateTransition.validateStructure(identityTopUpTransition)];
                case 1:
                    result = _a.sent();
                    if (!result.isValid()) {
                        throw new Error("StateTransition is invalid - " + JSON.stringify(result.getErrors()));
                    }
                    return [2 /*return*/, identityTopUpTransition];
            }
        });
    });
}
