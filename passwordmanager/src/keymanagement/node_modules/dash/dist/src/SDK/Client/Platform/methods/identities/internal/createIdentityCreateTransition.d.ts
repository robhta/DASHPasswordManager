 ...
 */
export default function createIdentityCreateTransition(platform: Platform, assetLockTransaction: Transaction, assetLockOutputIndex: number, assetLockProof: any, assetLockPrivateKey: PrivateKey): Promise<{
    identity: any;
