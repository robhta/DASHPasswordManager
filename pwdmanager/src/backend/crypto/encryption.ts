...
export class Encryption {
    ...
    private encryptPrivateKey(privateKey: any, ENC_VALUE: string) {
    ...
    private getMasterKey(privateKey: any) {
    ...
    private getFileEncKey(privateKey: any) {
        return Buffer.from(privateKey).subarray(32,64);
    }

    public getKey(privateKey: any) {
    ...
    public fileLevelEncryption(privateKey: any, payload: any): EncryptedEntity {
    ...
    public fileLevelDecryption(aesKey: any, payload: any, authTag: any, aesInputVector: any) {
