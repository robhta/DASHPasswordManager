...
function makeGetIdentityRespondWithIdentity(client, dapiClientMock) {
    ...
    dapiClientMock.platform.broadcastStateTransition.callsFake(function (stBuffer) { return __awaiter(_this, void 0, void 0, function () {
        var interceptedIdentityStateTransition, identityToResolve;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client.platform.dpp.stateTransition.createFromBuffer(stBuffer)];
                case 1:
                    ...
                    if (interceptedIdentityStateTransition.getType() === stateTransitionTypes_1.default.IDENTITY_CREATE) {
                        identityToResolve = new Identity_1.default({
                        ...
                        dapiClientMock.platform.getIdentity.withArgs(identityToResolve.getId()).resolves(new GetIdentityResponse(identityToResolve.toBuffer(), getResponseMetadataFixture_1.default()));
                    }
                    return [2 /*return*/];
            }
        });
...
function createAndAttachTransportMocksToClient(client, sinon) {
    return __awaiter(this, void 0, void 0, function () {
        var txStreamMock, transportMock, dapiClientMock, accountPromise;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
