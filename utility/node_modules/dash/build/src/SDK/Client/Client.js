...
var Client = /** @class */ (function (_super) {
    ...
    function Client(options) {
        ...
        _this.walletAccountIndex = 0;
        _this.options = __assign({ walletAccountIndex: 0 }, options);
        ...
        if (_this.options.wallet !== undefined) {
            if (_this.options.wallet.network !== undefined && _this.options.wallet.network !== _this.network) {
            ...
            // @ts-ignore
            _this.walletAccountIndex = _this.options.walletAccountIndex;
        }
