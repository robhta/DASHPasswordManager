...
// @ts-ignore
var getDocumentsFixture = require('@dashevo/dpp/lib/test/fixtures/getDocumentsFixture');
// @ts-ignore
var getDataContractFixture = require('@dashevo/dpp/lib/test/fixtures/getDataContractFixture');
...
describe('Dash - Client', function suite() {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        (_a = _b.sent(), txStreamMock = _a.txStreamMock, transportMock = _a.transportMock, dapiClientMock = _a.dapiClientMock);
                    ...
                    case 3:
                        ...
                        walletTransaction = _b.sent();
                        // create an identity in the account so we can sign state transitions
                        identityFixture = createIdentityFixtureInAccount_1.createIdentityFixtureInAccount(account);
                        ...
                        dapiClientMock.platform.getIdentity.resolves(new GetIdentityResponse(identityFixture.toBuffer(), getResponseMetadataFixture_1.default()));
                        dapiClientMock.platform.getDataContract.resolves(new GetDataContractResponse(dataContractFixture.toBuffer(), getResponseMetadataFixture_1.default()));
                        return [2 /*return*/];
                }
            });
        });
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, client.platform.dpp.stateTransition.createFromBuffer(serializedSt)];
                        case 2:
                            ...
                            chai_1.expect(interceptedAssetLockProof.getInstantLock()).to.be.deep.equal(isLock);
                            chai_1.expect(interceptedAssetLockProof.getTransaction().hash).to.be.equal(transaction.hash);
    ...
    describe('#platform.identities.topUp', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            it('should top up an identity', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, client.platform.identities.register()];
                        case 1:
                            identity = _a.sent();
    ...
    describe('#platform.documents.broadcast', function () {
        ...
        it('should broadcast documents', function () { return __awaiter(_this, void 0, void 0, function () {
            var proofResponse, serializedSt, interceptedSt, documentTransitions;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        proofResponse = {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, client.platform.dpp.stateTransition.createFromBuffer(serializedSt)];
                    case 2:
                        interceptedSt = _a.sent();
                        // .to.be.true() doesn't work after TS compilation in Chrome
                        chai_1.expect(interceptedSt.verifySignature(identityFixture.getPublicKeyById(0))).to.be.equal(true);
    ...
    describe('#platform.contracts.broadcast', function () {
        it('should throw TransitionBroadcastError when transport resolves error', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, client.platform.contracts.broadcast(dataContractFixture, identityFixture)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
        ...
        it('should broadcast data contract', function () { return __awaiter(_this, void 0, void 0, function () {
            var serializedSt, interceptedSt;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        // .to.be.true() doesn't work after TS compilation in Chrome
                        chai_1.expect(interceptedSt.verifySignature(identityFixture.getPublicKeyById(0))).to.be.equal(true);
                        chai_1.expect(interceptedSt.getEntropy()).to.be.deep.equal(dataContractFixture.entropy);
                        chai_1.expect(interceptedSt.getDataContract().toObject()).to.be.deep.equal(dataContractFixture.toObject());
                        return [2 /*return*/];
                }
            });
        }); });
