            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        walletTransaction = createTransactionFixtureInAccount_1.createTransactionInAccount(account);
    ...
    describe('#platform.identities.register', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            it('should register an identity', function () { return __awaiter(_this, void 0, void 0, function () {
                var accountIdentitiesCountBeforeTest, identity, serializedSt, interceptedIdentityStateTransition, interceptedAssetLock, transaction, isLock, importedIdentityIds;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 4:
                            ...
                            chai_1.expect(error.getData()).to.be.equal(errorResponse.error.data);
                            importedIdentityIds = account.identities.getIdentityIds();
    ...
    describe('#platform.identities.topUp', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            it('should top up an identity', function () { return __awaiter(_this, void 0, void 0, function () {
                var identity, serializedSt, interceptedIdentityStateTransition, interceptedAssetLock, transaction, isLock;
                return __generator(this, function (_a) {
                    switch (_a.label) {
