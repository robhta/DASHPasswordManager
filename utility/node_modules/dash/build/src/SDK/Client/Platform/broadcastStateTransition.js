 ...
 */
function broadcastStateTransition(platform, stateTransition) {
    return __awaiter(this, void 0, void 0, function () {
        var client, dpp, result, consensusError, hash, serializedStateTransition, error_1, cause, stateTransitionResult, error, grpcError, cause;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    client = platform.client, dpp = platform.dpp;
                    return [4 /*yield*/, dpp.stateTransition.validateBasic(stateTransition)];
                case 1:
                    result = _a.sent();
                    if (!result.isValid()) {
                ...
                case 4:
                    ...
                    throw error_1;
                case 5: return [4 /*yield*/, client.getDAPIClient().platform.waitForStateTransitionResult(hash, { prove: true })];
                case 6:
                    stateTransitionResult = _a.sent();
                    error = stateTransitionResult.error;
                    if (error) {
                        grpcError = new GrpcError(error.code, error.message, error.data);
                        cause = createGrpcTransportError(grpcError);
                        // Pass DPP consensus error directly to avoid
                        // additional wrappers
                        if (cause instanceof InvalidRequestDPPError) {
                            cause = cause.getConsensusError();
                    ...
                    return [2 /*return*/, stateTransitionResult.proof];
            }
        });
    });
}
