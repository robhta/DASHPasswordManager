...
function get(id) {
    return __awaiter(this, void 0, void 0, function () {
        var identifier, identityResponse, e_1, identity, metadata, responseMetadata;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, this.initialize()];
                case 1:
                    _a.sent();
                    identifier = Identifier_1.default.from(id);
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, this.client.getDAPIClient().platform.getIdentity(identifier)];
                case 3:
                ...
                case 4:
                    ...
                    throw e_1;
                case 5:
                    identity = this.dpp.identity.createFromBuffer(identityResponse.getIdentity());
                    metadata = null;
                    responseMetadata = identityResponse.getMetadata();
                    if (responseMetadata) {
