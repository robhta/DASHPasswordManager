...
describe('Platform', function () {
    describe('Names', function () {
        describe('#resolve', function () {
            ...
            it('should resolve domain by it\'s name', function () { return __awaiter(void 0, void 0, void 0, function () {
                var receivedDocument;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            platformMock.documents.get.resolves([parentDomainDocument]);
                            return [4 /*yield*/, resolve_1.default.call(platformMock, 'parent')];
                        case 1:
                            receivedDocument = _a.sent();
                            ...
                            chai_1.expect(receivedDocument).to.deep.equal(parentDomainDocument);
                            return [2 /*return*/];
                    }
                });
            }); });
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, resolve_1.default.call(platformMock, 'otherName.parent')];
                        case 1:
                            receivedDocument = _a.sent();
                            chai_1.expect(platformMock.documents.get.callCount).to.equal(1);
                            chai_1.expect(platformMock.documents.get.getCall(0).args).to.deep.equal([
                            ...
                            chai_1.expect(receivedDocument).to.be.null;
                            return [2 /*return*/];
                    }
                });
            }); });
