...
function get(typeLocator, opts) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, appName, fieldType, appDefinition, binaryProperties_1, rawDocuments;
        var _this = this;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    rawDocuments = _b.sent();
                    return [2 /*return*/, Promise.all(rawDocuments.map(function (rawDocument) { return _this.dpp.document.createFromBuffer(rawDocument); }))];
            }
        });
    });
}
