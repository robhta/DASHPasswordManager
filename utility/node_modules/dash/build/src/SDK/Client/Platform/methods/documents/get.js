...
var Metadata_1 = __importDefault(require("@dashevo/dpp/lib/Metadata"));
/**
 * Prefetch contract
 *
...
function convertIdentifierProperties(whereCondition, binaryProperties, parentProperty) {
    ...
    var isPropertyIdentifier = property && property.contentMediaType === Identifier_1.default.MEDIA_TYPE;
    ...
    if (isSystemIdentifier || (isPropertyIdentifier && typeof propertyValue === 'string')) {
        convertedPropertyValue = Identifier_1.default.from(propertyValue);
    }
...
function get(typeLocator, opts) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, appName, fieldType, appDefinition, binaryProperties_1, documentsResponse, rawDocuments;
        var _this = this;
            ...
            switch (_b.label) {
                ...
                case 2:
                    ...
                    if (opts.where) {
                        ...
                        opts.where = opts.where.map(function (whereCondition) { return convertIdentifierProperties(whereCondition, binaryProperties_1); });
                    }
                ...
                case 3:
                    ...
                    return [2 /*return*/, Promise.all(rawDocuments.map(function (rawDocument) { return __awaiter(_this, void 0, void 0, function () {
                            var document, metadata, responseMetadata;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this.dpp.document.createFromBuffer(rawDocument)];
                                    case 1:
                                        document = _a.sent();
                                        metadata = null;
