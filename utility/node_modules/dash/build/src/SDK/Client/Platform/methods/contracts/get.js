    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    _d.sent();
                    contractId = Identifier_1.default.from(identifier);
                ...
                case 2:
                    _d.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, this.client.getDAPIClient().platform.getDataContract(contractId)];
                case 3:
                    dataContractResponse = _d.sent();
                    return [3 /*break*/, 5];
                case 4:
                    e_1 = _d.sent();
                    ...
                    throw e_1;
                case 5: return [4 /*yield*/, this.dpp.dataContract.createFromBuffer(dataContractResponse.getDataContract())];
                case 6:
                    contract = _d.sent();
                    metadata = null;
