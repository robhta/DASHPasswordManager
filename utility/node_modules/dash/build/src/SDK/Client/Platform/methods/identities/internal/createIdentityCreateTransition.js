 ...
 */
function createIdentityCreateTransition(platform, assetLockTransaction, assetLockOutputIndex, assetLockProof, assetLockPrivateKey) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, platform.client.getWalletAccount()];
                case 1:
                    account = _a.sent();
                    dpp = platform.dpp;
                    return [4 /*yield*/, account.getUnusedIdentityIndex()];
                case 2:
                    identityIndex = _a.sent();
                    identityPrivateKey = account.identities.getIdentityHDKeyByIndex(identityIndex, 0).privateKey;
                    identityPublicKey = identityPrivateKey.toPublicKey();
                    identity = dpp.identity.create(assetLockTransaction, assetLockOutputIndex, assetLockProof, [identityPublicKey]);
                    ...
                    return [4 /*yield*/, dpp.stateTransition.validateStructure(identityCreateTransition)];
                case 3:
                    result = _a.sent();
                    if (!result.isValid()) {
