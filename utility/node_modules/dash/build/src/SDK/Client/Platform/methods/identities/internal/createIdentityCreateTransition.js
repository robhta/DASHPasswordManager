 ...
 */
function createIdentityCreateTransition(platform, assetLockProof, assetLockPrivateKey) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    identity = dpp.identity.create(assetLockProof, [identityPublicKey]);
                    ...
                    return [4 /*yield*/, dpp.stateTransition.validateBasic(identityCreateTransition)];
                case 4:
                    result = _a.sent();
                    if (!result.isValid()) {
