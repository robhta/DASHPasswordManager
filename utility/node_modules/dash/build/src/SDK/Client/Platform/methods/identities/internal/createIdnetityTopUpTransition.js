 ...
 */
function createIdentityTopUpTransition(platform, assetLockProof, assetLockPrivateKey, identityId) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    dpp = platform.dpp;
                    identityTopUpTransition = dpp.identity.createIdentityTopUpTransition(identityId, assetLockProof);
                    identityTopUpTransition.signByPrivateKey(assetLockPrivateKey);
                    return [4 /*yield*/, dpp.stateTransition.validateBasic(identityTopUpTransition)];
                case 2:
                    result = _a.sent();
                    if (!result.isValid()) {
