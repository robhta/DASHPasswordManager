 ...
 */
function search(labelPrefix, parentDomainName) {
    if (parentDomainName === void 0) { parentDomainName = ''; }
    return __awaiter(this, void 0, void 0, function () {
        var normalizedParentDomainName, normalizedLabelPrefix, documents;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    normalizedLabelPrefix = labelPrefix.toLowerCase();
                    return [4 /*yield*/, this.documents.get('dpns.domain', {
                            where: [
