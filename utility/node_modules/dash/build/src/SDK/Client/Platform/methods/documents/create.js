 ...
 */
function create(typeLocator, identity, data) {
    if (data === void 0) { data = {}; }
    return __awaiter(this, void 0, void 0, function () {
        var dpp, appNames, _a, appName, fieldType, contractId, dataContract;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    dpp = this.dpp;
                    appNames = this.client.getApps().getNames();
                    _a = (typeLocator.includes('.')) ? typeLocator.split('.') : [appNames[0], typeLocator], appName = _a[0], fieldType = _a[1];
                    contractId = this.client.getApps().get(appName).contractId;
