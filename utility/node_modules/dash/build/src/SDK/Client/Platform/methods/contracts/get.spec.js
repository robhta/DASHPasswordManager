...
var factory = new DataContractFactory_1.default(function () {
...
describe('Client - Platform - Contracts - .get()', function () {
    before(function () {
        askedFromDapi = 0;
        var getDataContract = function (id) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        contract = _a.sent();
                        return [2 /*return*/, contract.toBuffer()];
    ...
    describe('get a contract from string', function () {
        it('should get from DAPIClient if there is none locally', function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, get_1.default.call({ apps: apps, dpp: dpp, client: client }, contracts_json_1.default.ratePlatform.$id)];
                        case 1:
                            contract = _a.sent();
    ...
    describe('other conditions', function () {
        it('should deal when contract do not exist', function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, get_1.default.call({ apps: apps, dpp: dpp, client: client }, identities_json_1.default.bob.id)];
                        case 1:
                            contract = _a.sent();
