...
var factory = new DataContractFactory_1.default(undefined, function () {
    return new ValidationResult_1.default();
}, function () { return [42, contracts_json_1.default.ratePlatform]; });
var dpp = {
...
describe('Client - Platform - Contracts - .get()', function () {
        ...
        var getDataContract = function (id) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        contract = _a.sent();
                        return [2 /*return*/, new GetDataContractResponse(contract.toBuffer(), getResponseMetadataFixture_1.default())];
                    case 2: throw new NotFoundError();
                }
            });
        }); };
        client = {
            getDAPIClient: function () {
                return {
                    platform: {
    ...
    describe('get a contract from string', function () {
        it('should get from DAPIClient if there is none locally', function () {
            return __awaiter(this, void 0, void 0, function () {
                var contract;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, get_1.default.call({ apps: apps, dpp: dpp, client: client, initialize: initialize }, contracts_json_1.default.ratePlatform.$id)];
                        case 1:
                            contract = _a.sent();
        ...
        it('should get from local when already fetched once', function () {
            return __awaiter(this, void 0, void 0, function () {
                var contract;
                return __generator(this, function (_a) {
                    switch (_a.label) {
    ...
    describe('other conditions', function () {
        it('should deal when contract do not exist', function () {
            return __awaiter(this, void 0, void 0, function () {
                var contract;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, get_1.default.call({ apps: apps, dpp: dpp, client: client, initialize: initialize }, identities_json_1.default.bob.id)];
                        case 1:
                            contract = _a.sent();
