...
describe('Platform', function () {
    describe('Names', function () {
        describe('#search', function () {
            ...
            it('should return a list of searched domains', function () { return __awaiter(void 0, void 0, void 0, function () {
                var documentsList;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            platformMock.documents.get.resolves([parentDomainDocument]);
                            return [4 /*yield*/, search_1.default.call(platformMock, 'prefix', 'dash')];
                        case 1:
                            documentsList = _a.sent();
            ...
            it('should return an empty list if no domains where found', function () { return __awaiter(void 0, void 0, void 0, function () {
                var documentsList;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
